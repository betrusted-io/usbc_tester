...
impl SbLed {
    ...
    pub fn pass(&mut self) {
        ...
        csr.wo(
            utra::sbled::RAW,
            csr.ms(utra::sbled::RAW_R, 0) |  // white
            csr.ms(utra::sbled::RAW_G, 0) |  // red
            csr.ms(utra::sbled::RAW_B, 1)    // green
        );
    }
    ...
    pub fn fail(&mut self) {
        ...
        csr.wo(
            utra::sbled::RAW,
            csr.ms(utra::sbled::RAW_R, 0) |  // white
            csr.ms(utra::sbled::RAW_G, 1) |  // red
            csr.ms(utra::sbled::RAW_B, 0)    // green
        );
    }
    ...
    pub fn run(&mut self) {
        ...
        csr.wo(
            utra::sbled::RAW,
            csr.ms(utra::sbled::RAW_R, 1) |  // white
            csr.ms(utra::sbled::RAW_G, 0) |  // red
            csr.ms(utra::sbled::RAW_B, 0)    // green
        );
    }
